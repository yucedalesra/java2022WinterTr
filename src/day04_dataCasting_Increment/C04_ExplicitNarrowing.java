...
public class C04_ExplicitNarrowing {
    ...
    public static void main(String[] args) {
        ...
        int sayi4 = (int) (sayi1/sayi2);    // deger double variable int
                                          ...
                                          //sorumlulugu üstlenmemizi ister
        ...
        int sayi5 =  140;
        byte sayi6 = (byte) sayi5; // sag taraftaki int > sol taraftaki variable byte
        ...
        // YANI buyuk data turunu kucuge cevirmek istedigimizde sorumlulugu aliyoruz (PARANTEZ ICINDE ISTISNAYI YAZARAK)
