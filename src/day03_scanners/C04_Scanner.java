...
public class C04_Scanner {
    ...
    public static void main(String[] args) {
        ...
        // ve olusturulan bu scanner scan variable'ina assing edilir
        // scan variable ismidir istedigimiz ismi verebiliriz

        //2. adim kulanicidan istedigimiz degeri girmesi icin aciklayici bir bilgi yazdirin
